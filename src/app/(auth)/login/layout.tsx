...
export default async function SessionLayout({ children }: { children: ReactNode }) {
	return (
		<div className={twMerge(['flex min-h-dvh text-slate-600 antialiased', 'lg:grid lg:grid-cols-2 lg:p-0'])}>
			<div className="relative hidden h-full flex-col justify-between border-r border-foreground/5 p-10 lg:flex">
			...
			<div className="relative flex flex-col items-center justify-center bg-secondary">{children}</div>
		</div>
	);
}
